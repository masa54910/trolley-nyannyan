...
export class StageManager {
  static createInitialStage(): Stage {
    const tiles: Tile[] = [
      ...
      panel(4, 3, "straight", 90, "brown", { bonus: true }),
